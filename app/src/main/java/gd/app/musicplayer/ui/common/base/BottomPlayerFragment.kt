...
@AndroidEntryPoint
class BottomPlayerFragment : ViewBindingFragment<MainBottomControlPanelBinding>() {
    private val viewModel: PlaybackControlViewModel by viewModels()
    private val pagerAdapter by lazy { BottomControlPagerAdapter(::openPlayer) }
...
private class BottomControlPagerAdapter(
