package gd.app.musicplayer.ui.feature.tags
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val success = when (currentSet) {
                ...
                is MusicSet.Artist -> {
                    ...
                    musicSetMetadataRepo.updateArtistMetadata(currentSet, newName)
                }
                ...
                is MusicSet.Genre -> {
                    ...
                    musicSetMetadataRepo.updateGenreMetadata(currentSet, newName)
                }
