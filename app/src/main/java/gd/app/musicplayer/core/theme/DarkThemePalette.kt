...
class DarkThemePalette : PictureThemePalette() {
    ...
    override fun getActivityBackgroundDrawable(context: Context): Drawable = ColorDrawable(DARK_SURFACE)
    ...
    override fun getPopupBackgroundDrawable(context: Context): Drawable =
        AppCompatResources.getDrawable(context, R.drawable.popup_bg_night) ?: ColorDrawable(DARK_SURFACE)
    ...
    override fun getBlurredBackgroundDrawable(context: Context): Drawable = ColorDrawable(DARK_SURFACE)
