...
import gd.app.musicplayer.ui.common.dialog.BaseDialogFragment
import androidx.core.graphics.drawable.toDrawable
import gd.app.lib.view.RoundedOutlineProvider
import gd.app.lib.view.square.SquareConfig
import gd.app.lib.view.square.SquareConfig.Companion.BY_WIDTH
...
class SimultaneousTipDialog : BaseDialogFragment() {
    ...
    private fun applyThemeToViews(topCornerRadius: Float) {
        val themePalette =
            requireContext().appContainer.themeRegistry.getCurrentTheme(requireContext())
