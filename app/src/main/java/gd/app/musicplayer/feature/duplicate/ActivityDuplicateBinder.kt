...
class ActivityDuplicateBinder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (val row = rows[position]) {
            ...
            is Row.ChildRow -> (holder as ChildViewHolder).bind(
                ...
                selected = row.music._id in selectedIds
            )
        }
    }
    ...
    override fun onBindViewHolder(
        ...
        if (payloads.contains(PAYLOAD_SELECTION) && holder is ChildViewHolder) {
            ...
            holder.updateSelection(row.music._id in selectedIds)
            return
        }
    ...
    private sealed interface Row {
        ...
        data class ChildRow(
            ...
            override val stableId: Long = ("child:$groupKey:${music._id}").hashCode().toLong()
        }
    }
