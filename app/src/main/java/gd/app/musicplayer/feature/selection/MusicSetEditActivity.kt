...
class MusicSetEditActivity : BaseActivity() {
    ...
    private val playTracks by lazy { appContainer.playTracksUseCase }
    private val enqueueTracks by lazy { appContainer.enqueueTracksUseCase }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        preferenceUtil = appContainer.preferenceUtil
    ...
    private fun handleAction(action: String) {
        ...
        lifecycleScope.launch {
            ...
            when (action) {
                ACTION_ADD_TO -> ActivityPlaylistSelect.Companion.start(this@MusicSetEditActivity, tracks)
