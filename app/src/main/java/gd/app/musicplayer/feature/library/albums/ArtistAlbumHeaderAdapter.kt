...
class ArtistAlbumHeaderAdapter(
    private val onAlbumClick: (MusicSet.Album) -> Unit
) : RecyclerView.Adapter<ArtistAlbumHeaderAdapter.HeaderViewHolder>() {

    private var albums: List<MusicSet.Album> = emptyList()
    ...
    fun submitAlbums(newAlbums: List<MusicSet.Album>) {
    ...
    class HeaderViewHolder(
        ...
        fun bind(
            albums: List<MusicSet.Album>,
            onAlbumClick: (MusicSet.Album) -> Unit
        ) {
