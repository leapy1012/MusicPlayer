...
import gd.app.musicplayer.feature.widget.provider.BaseMusicAppWidgetProvider
    ...
    private class QueueFactory(
        ...
        override fun getViewAt(position: Int): RemoteViews {
            ...
            return RemoteViews(packageName, R.layout.widget_queue_item).apply {
                ...
                val fillInIntent = Intent().putExtra(BaseMusicAppWidgetProvider.Companion.EXTRA_QUEUE_INDEX, position)
        ...
        override fun getItemId(position: Int): Long = items.getOrNull(position)?._id ?: position.toLong()
