...
import gd.app.musicplayer.core.theme.ThemeManager.Companion.THEME_TYPE_DARK
import gd.app.musicplayer.core.theme.ThemeManager.Companion.THEME_TYPE_PICTURE
...
class SettingActivity : BaseActivity() {
    ...
    private fun setupInteractions() {
        ...
        binding.preferenceDarkMode.setOnClickListener {
            ...
            if (next)
                preferenceUtil.putIntPreference("theme_type", THEME_TYPE_DARK)
            else
                preferenceUtil.putIntPreference("theme_type", THEME_TYPE_PICTURE)
        ...
        binding.preferenceFindDuplicate.setOnClickListener {
            ActivityDuplicatedFinder.Companion.start(this)
        }
        ...
        binding.preferenceStatusBarLyrics.setOnClickListener {
            ActivityStatusBarLyrics.Companion.start(this)
        }
    ...
    private fun syncDarkModeState() {
        ...
        binding.preferenceDarkMode.isSelected = themeType == THEME_TYPE_DARK
    }
    ...
    private fun showReplayGainPreampDialog() {
        ...
        appContainer.themeEngine.apply(contentView)
        ...
        val palette = appContainer.themeRepo.getCorePalette(this)
    ...
    private fun themedListDialogConfig(items: List<String>): ChoiceListDialog.Config {
        val palette = appContainer.themeRepo.getCorePalette(this)
        return ChoiceListDialog.Config.create(this, items).apply {
            titleTextColor = palette.titleColor
